...
public class Main {
    ...
    final static String USBPORT = "COM4";
    final static int SENSOR = 15;
    final static int PUMP = 7;
            ...
            throws IOException, InterruptedException
    {
        ...
        myArduinoBoard.addEventListener(new Button_Task(buttonPin));

        // Moisture task class instantiating
        Moisture_Task moisture_Task = new Moisture_Task(moisturePin, pumpPin);
        var myTask = new Moisture_Task(myArduinoBoard);
